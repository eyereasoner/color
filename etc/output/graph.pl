...
'http://www.w3.org/2000/10/swap/log#proves'((('urn:example:path'(C,D),'urn:example:path'(D,E)=>'urn:example:path'(C,E)),'urn:example:path'('urn:example:chartres','urn:example:lemans'),'urn:example:path'('urn:example:lemans','urn:example:angers')),'urn:example:path'('urn:example:chartres','urn:example:angers')).
'http://www.w3.org/2000/10/swap/log#proves'((('urn:example:path'(C,D),'urn:example:path'(D,E)=>'urn:example:path'(C,E)),'urn:example:path'('urn:example:chartres','urn:example:lemans'),'urn:example:path'('urn:example:lemans','urn:example:tours')),'urn:example:path'('urn:example:chartres','urn:example:tours')).
'http://www.w3.org/2000/10/swap/log#proves'((('urn:example:path'(C,D),'urn:example:path'(D,E)=>'urn:example:path'(C,E)),'urn:example:path'('urn:example:lemans','urn:example:angers'),'urn:example:path'('urn:example:angers','urn:example:nantes')),'urn:example:path'('urn:example:lemans','urn:example:nantes')).
'http://www.w3.org/2000/10/swap/log#proves'((('urn:example:path'(I,J),'urn:example:path'(J,K)=>'urn:example:path'(I,K)),'urn:example:path'('urn:example:paris','urn:example:orleans'),'urn:example:path'('urn:example:orleans','urn:example:tours')),'urn:example:path'('urn:example:paris','urn:example:tours')).
'http://www.w3.org/2000/10/swap/log#proves'((('urn:example:path'(I,J),'urn:example:path'(J,K)=>'urn:example:path'(I,K)),'urn:example:path'('urn:example:paris','urn:example:chartres'),'urn:example:path'('urn:example:chartres','urn:example:angers')),'urn:example:path'('urn:example:paris','urn:example:angers')).
'http://www.w3.org/2000/10/swap/log#proves'((('urn:example:path'(I,J),'urn:example:path'(J,K)=>'urn:example:path'(I,K)),'urn:example:path'('urn:example:chartres','urn:example:lemans'),'urn:example:path'('urn:example:lemans','urn:example:nantes')),'urn:example:path'('urn:example:chartres','urn:example:nantes')).
'http://www.w3.org/2000/10/swap/log#proves'((('urn:example:path'(I,J),'urn:example:path'(J,K)=>'urn:example:path'(I,K)),'urn:example:path'('urn:example:paris','urn:example:lemans'),'urn:example:path'('urn:example:lemans','urn:example:nantes')),'urn:example:path'('urn:example:paris','urn:example:nantes')).
