...
% queries
query('urn:example:primerange'(0, 100, _)).
query('urn:example:primerange'(1000000, 1000100, _)).
query('urn:example:totient'(271, _)).
query('urn:example:totient'(2718281, _)).
query('urn:example:totient'(27182818284, _)).
query('urn:example:totient'(271828182845904, _)).
