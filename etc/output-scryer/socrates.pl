...
% proof steps
step(('<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>'('Socrates','<urn:example:Man>'),'<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>'(A,'<urn:example:Man>'):+true),true,('<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>'('Socrates','<urn:example:Man>'),'<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>'(sk_0,'<urn:example:Man>'))).
step(('<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>'('Socrates','<urn:example:Man>'),'<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>'(A,'<urn:example:Man>'):+true),true,('<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>'('Socrates','<urn:example:Man>'),'<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>'(sk_0,'<urn:example:Man>'))).
...
step((true:+'<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>'(A,B)),'<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>'(sk_0,'<urn:example:Man>'),true).
...
step((true:+'<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>'(A,B)),'<http://www.w3.org/1999/02/22-rdf-syntax-ns#type>'(sk_0,'<urn:example:Mortal>'),true).
