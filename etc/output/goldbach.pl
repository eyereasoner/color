...
answer('urn:example:goldbach'(137438953472, [31, 137438953441])).
...
step((true:+'urn:example:goldbach'(137438953472, [_, _])), 'urn:example:goldbach'(137438953472, [31, 137438953441]), true).
