...
step(('urn:example:is'(A,'urn:example:observable'):+'urn:example:allPossibleCases'([A],B), \+ (member('urn:example:is'(A,C),B), \+ ('urn:example:is'(A,'urn:example:observable'):+'urn:example:is'(A,C)))),('urn:example:allPossibleCases'(['urn:example:water'],['urn:example:is'('urn:example:water','urn:example:solid'),'urn:example:is'('urn:example:water','urn:example:liquid'),'urn:example:is'('urn:example:water','urn:example:gas')]), \+ (member('urn:example:is'('urn:example:water',C),['urn:example:is'('urn:example:water','urn:example:solid'),'urn:example:is'('urn:example:water','urn:example:liquid'),'urn:example:is'('urn:example:water','urn:example:gas')]), \+ ('urn:example:is'('urn:example:water','urn:example:observable'):+'urn:example:is'('urn:example:water',C)))),'urn:example:is'('urn:example:water','urn:example:observable')).
