...
'urn:example:got'('urn:example:all', 'urn:example:dinner') :-
    ...
    thread_create('urn:example:run'('urn:example:person2', 0.2, 0.1), B, []),
    thread_create('urn:example:run'('urn:example:person3', 0.1, 0.1), C, []),
    thread_create('urn:example:run'('urn:example:person4', 0.2, 0.2), D, []),
    thread_create('urn:example:run'('urn:example:person5', 0.1, 0.1), E, []),
    thread_join(A, _),
    thread_join(B, _),
    thread_join(C, _),
    thread_join(D, _),
