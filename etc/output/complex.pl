...
answer('urn:example:exponentiation'([[e, 0], [0, pi]], [-1.0, 1.2246467991473532e-16])).
answer('urn:example:log'([[e, 0], [-1, 0]], [0.0, 3.141592653589793])).
...
step((true:+'urn:example:exponentiation'([[e, 0], [0, pi]], _)), 'urn:example:exponentiation'([[e, 0], [0, pi]], [-1.0, 1.2246467991473532e-16]), true).
step((true:+'urn:example:log'([[e, 0], [-1, 0]], _)), 'urn:example:log'([[e, 0], [-1, 0]], [0.0, 3.141592653589793]), true).
