...
query('urn:example:challengeProof'('urn:example:simulation1', 'urn:example:Mary', _, "94c9923c71b5dac8e5a8f409e3d5d285f7b0ca7d08fe7529a112103188726c75")).
query('urn:example:challengeProof'('urn:example:simulation1', 'urn:example:Pat', _, "66b486e614df3fcdb4ea91faa853fad3a50f170271254894bab22a234f430bee")).
