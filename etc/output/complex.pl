...
'urn:example:quotient'([[1,0],[0,1]],[0.0,-1.0]) => true.
'urn:example:exponentiation'([[-1,0],[0.5,0]],[6.123233995736766e-17,1.0]) => true.
2.718281828459045 is 0+e,'urn:example:exponentiation'([[2.718281828459045,0],[0,pi]],[-1.0,1.2246467991473532e-16]) => true.
2.718281828459045 is 0+e,'urn:example:log'([[2.718281828459045,0],[-1,0]],[0.0,3.141592653589793]) => true.
