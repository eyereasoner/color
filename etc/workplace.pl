...
'urn:example:does'(Person,'urn:example:work_related_task'),stable(1),\+'urn:example:does'(Person,'urn:example:log_off_at_end_of_shift') => 'urn:example:complies'(Person,false).
